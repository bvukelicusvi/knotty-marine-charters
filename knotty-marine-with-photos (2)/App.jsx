      ...
      <div style={{
        ...
        <div style={{ padding: "20px 28px 28px", flex: 1, display: "flex", flexDirection: "column" }}>
          ...
          <a href="#book-now" style={{
            ...
            color: charter.popular ? C.navy : C.navy,
...
export default function KnottyMarineSite() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: C.warmWhite, fontFamily: "'DM Sans', sans-serif", overflowX: "hidden" }}>
        ...
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          <FadeIn>
            <div style={{ textAlign: "center", marginBottom: "56px" }}>
              ...
              <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "16px", color: "#8b8378", maxWidth: "550px", margin: "0 auto", lineHeight: 1.6 }}>
      ...
      <section style={{
        padding: "60px 24px",
        background: `linear-gradient(175deg, ${C.cream}, ${C.warmWhite})`,
      }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr", gap: "16px" }}>
            <FadeIn>
              <div style={{ borderRadius: "16px", overflow: "hidden", height: "100%" }}>
                <img src={boatSunset} alt="Monterey 30 Elite at sunset" style={{
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              <FadeIn delay={0.15}>
                <div style={{ borderRadius: "16px", overflow: "hidden", flex: 1 }}>
                  <img src={boatAction} alt="Monterey 30 Elite cruising" style={{
                    width: "100%", height: "100%", objectFit: "cover", display: "block",
                  }} />
                </div>
              </FadeIn>
              <FadeIn delay={0.3}>
                <div style={{
                  borderRadius: "16px", overflow: "hidden", flex: 1, position: "relative",
                }}>
                  <img src={lunaPhoto} alt="Luna - the boat's namesake" style={{
                    width: "100%", height: "100%", objectFit: "cover", display: "block",
                  }} />
                  <div style={{
                    ...
                    <p style={{
                      ...
                      color: C.cream, margin: 0, fontWeight: 700,
                    }}>
                      Meet Luna
                    </p>
                    <p style={{
                      fontFamily: "'DM Sans', sans-serif", fontSize: "11px",
                      color: C.sand, margin: 0, opacity: 0.8,
                    }}>
            ...
            <FadeIn>
              <div style={{ background: "#fff", borderRadius: "16px", padding: "28px", border: `1px solid ${C.sand}40` }}>
                ...
                {[
                  ...
                  "Cash for beach bars, food stops & fuel",
            ...
            <FadeIn delay={0.15}>
              <div style={{ background: "#fff", borderRadius: "16px", padding: "28px", border: `2px solid ${C.rust}25` }}>
                ...
                <div style={{
                  ...
                  background: `${C.rust}08`, border: `1px solid ${C.rust}20`,
                }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
            {[
              ...
              <FadeIn key={i} delay={i * 0.05}>
                <div style={{
                  background: `${C.cream}06`, borderRadius: "12px", padding: "20px 24px",
                  border: `1px solid ${C.gold}10`,
                }}>
                  <h3 style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "15px", fontWeight: 600, color: C.cream, margin: "0 0 8px" }}>
                    {faq.q}
                  </h3>
                  <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "14px", color: C.sand, lineHeight: 1.7, margin: 0, opacity: 0.85 }}>
                    {faq.a}
                  </p>
                </div>
              </FadeIn>
        ...
        <div style={{ maxWidth: "600px", margin: "0 auto", position: "relative", zIndex: 1 }}>
          ...
          <FadeIn delay={0.2}>
            <div style={{ display: "flex", gap: "16px", justifyContent: "center", flexWrap: "wrap", marginBottom: "32px" }}>
              <a href="mailto:KMCUSVI@gmail.com" style={{
