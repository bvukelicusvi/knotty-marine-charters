...
// #1 — Gallery dropdown in nav with upload capability
function GalleryModal({ onClose }) {
  ...
  return (
    <div style={{
      ...
      background: "rgba(6,18,34,0.96)", backdropFilter: "blur(12px)",
      ...
      <div style={{ maxWidth: "1000px", width: "100%", margin: "0 auto", padding: "40px 24px" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "32px" }}>
          ...
          <button onClick={onClose} style={{
            background: `${C.cream}10`, border: `1px solid ${C.cream}20`, color: C.cream,
            width: "40px", height: "40px", borderRadius: "50%", cursor: "pointer",
            fontFamily: "'DM Sans', sans-serif", fontSize: "18px", display: "flex", alignItems: "center", justifyContent: "center",
          }}>✕</button>
        </div>
        ...
        <div
          ...
          style={{
            border: `2px dashed ${C.gold}50`, borderRadius: "16px", padding: "40px",
            textAlign: "center", cursor: "pointer", marginBottom: "32px",
            background: `${C.gold}05`, transition: "border-color 0.2s",
          }}
        >
          <input
            ref={fileInputRef}
          ...
          <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "14px", color: C.sand, margin: 0, opacity: 0.7 }}>
            Drag & drop photos here, or click to select files. Share your Knotty Marine memories!
          </p>
        </div>
        ...
        {photos.length === 0 ? (
          <div style={{ textAlign: "center", padding: "60px 0" }}>
            <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "16px", color: C.sand, opacity: 0.5 }}>
              No photos yet — be the first to share your charter memories!
            </p>
          </div>
        ) : (
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(220px, 1fr))", gap: "16px" }}>
            {photos.map((p, i) => (
              <div key={i} style={{ borderRadius: "12px", overflow: "hidden", border: `1px solid ${C.gold}20`, position: "relative" }}>
...
/* ─── Nav ─── */
// #1 — Gallery dropdown added to nav
      ...
      <nav style={{
        ...
        <div style={{ display: "flex", gap: "24px", alignItems: "center" }}>
          ...
          <button
            ...
            style={{
              fontFamily: "'DM Sans', sans-serif", fontSize: "13px", fontWeight: 500,
              color: C.sand, background: "transparent", border: `1px solid ${C.gold}40`,
  ...
  return (
    <section style={{
      ...
      <div style={{
        ...
        background: `repeating-linear-gradient(90deg, transparent 0px, transparent 80px, ${C.gold}04 80px, ${C.gold}04 82px)`,
        opacity: 0.5,
      }} />
      ...
      <div style={{ position: "relative", zIndex: 1, maxWidth: "800px" }}>
        ...
        {/* #2 — Increased font size for U.S. VIRGIN ISLANDS */}
        <FadeIn delay={0.15}>
          <p style={{
            fontFamily: "'Oswald', sans-serif", fontSize: "20px", letterSpacing: "8px",
            color: C.gold, marginBottom: "16px", fontWeight: 500,
          }}>
            U.S. VIRGIN ISLANDS
          </p>
        </FadeIn>
        ...
        {/* #4 — Increased font size for veteran badge on hero */}
        <FadeIn delay={0.9}>
          <div style={{
            display: "inline-flex", alignItems: "center", gap: "12px",
            padding: "12px 28px", borderRadius: "30px", marginTop: "48px",
            border: `1px solid ${C.gold}20`, background: `${C.gold}06`,
          }}>
            <span style={{ fontSize: "15px", color: C.rust, letterSpacing: "2px", fontWeight: 700, fontFamily: "'Oswald', sans-serif" }}>
              ★ SERVICE DISABLED VETERAN OWNED
            </span>
            <span style={{ color: C.gold, fontSize: "8px" }}>◆</span>
            <span style={{ fontSize: "15px", color: C.sand, letterSpacing: "2px", fontWeight: 500, fontFamily: "'Oswald', sans-serif" }}>
...
/* ─── Charter Cards ─── */
// Updates applied: #5 drinks→water, #6 lunch options, #7 sunset cruise, #8 bach party, #9 new trip, #11 cruise ship, #12 foodie tour, #13 custom day tour
const charters = [
  {
  ...
  },
  {
    ...
    // #7 — removed rum punch/cocktails and appetizer spread; added cooler with ice and water
    features: ["Cooler with ice & water", "Prime sunset route", "Bluetooth sound system", "Up to 10 guests"],
    icon: "🌅",
    popular: false,
  },
  {
    // #8 — 7-8 hours, price $1,300
  ...
  {
    // #11 — price $1,300, added Lime Out floating taco bar
  ...
  {
    // #12 — updated to let guests pick their lunch spot
  ...
  {
    // #9 — New: Circumnavigate St. John and/or St. Thomas Full Day Tour
  ...
  {
    // #13 — Build Your Own Full Day Tour
    title: "Build Your Own Charter",
    hours: "Full Day",
    price: "From $1,300",
...
// #14 — student trip: removed teacher/chaperone, min 6 students up to 10, added snacks & water/ice
const studentTrip = {
    ...
    <FadeIn delay={index * 0.1} style={{ flex: "1 1 280px", maxWidth: "360px" }}>
      <div style={{
        ...
        <div style={{ padding: "20px 28px 28px", flex: 1, display: "flex", flexDirection: "column" }}>
          ...
          {/* #6 — Lunch note for trips with lunch stops */}
          {charter.lunchNote && (
            <p style={{
              fontFamily: "'DM Sans', sans-serif", fontSize: "12px", color: "#8b8378",
              margin: "-12px 0 16px", fontStyle: "italic", lineHeight: 1.5,
            }}>
          ...
          <a href="#book-now" style={{
            ...
            background: charter.popular ? C.gold : "transparent",
            color: C.navy,
            border: charter.popular ? "none" : `1.5px solid ${C.navy}25`,
...
export default function KnottyMarineSite() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: C.warmWhite, fontFamily: "'DM Sans', sans-serif", overflowX: "hidden" }}>
          ...
          <FadeIn>
            <div style={{ textAlign: "center", marginBottom: "56px" }}>
              ...
              <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "16px", color: "#8b8378", maxWidth: "550px", margin: "0 auto 12px", lineHeight: 1.6 }}>
                From half-day snorkel runs to full-day island expeditions, bachelorette parties to student field trips — pick your adventure and we'll handle the rest.
              </p>
              {/* #3 — Price does not include fuel and gratuity notice in red */}
          ...
          <FadeIn delay={0.5}>
            <div style={{
              ...
              <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "14px", color: "#8b8378", margin: "0 0 6px" }}>
                All charters include snorkel gear, water, ice, and Bluetooth speakers. No passport required for USVI trips.
              </p>
              <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "13px", color: C.rust, margin: "0 0 6px", fontWeight: 700 }}>
                ⚠ Price does not include Fuel or Gratuity.
              </p>
      ...
      {/* ═══ POPULAR DESTINATIONS ═══ — #16 moved up, below Charters */}
        ...
        <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
          <FadeIn>
            <div style={{ textAlign: "center", marginBottom: "48px" }}>
              <p style={{ fontFamily: "'Oswald', sans-serif", fontSize: "12px", letterSpacing: "5px", color: C.gold, marginBottom: "10px", fontWeight: 500 }}>
                WHERE WE TAKE YOU
              </p>
              <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "clamp(28px, 5vw, 42px)", fontWeight: 800, color: C.cream, margin: "0 0 8px", letterSpacing: "-0.03em" }}>
                Popular Destinations
              </h2>
              <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "15px", color: C.sand, maxWidth: "500px", margin: "0 auto", opacity: 0.8 }}>
                No passport required — all within the U.S. Virgin Islands
              </p>
            </div>
          </FadeIn>
          {/* #18 — Updated and expanded destinations */}
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(260px, 1fr))", gap: "16px" }}>
            {[
              ...
              { name: "Megan's Bay", desc: "One of the most beautiful beaches in the world — white sand, calm water, and stunning mountain backdrop. A must-see on any charter.", icon: "🌊" },
              { name: "Brewer's Bay", desc: "A quiet, locals-favorite beach tucked under the flight path of St. Thomas airport. Great snorkeling and a relaxed, off-the-beaten-path vibe.", icon: "🏄" },
              ...
              { name: "Sunset Cruise", desc: "Watch the Caribbean sun melt into the horizon from the water. The perfect way to end any day in the USVI — unforgettable views and golden skies.", icon: "🌇" },
              { name: "Island Hopping", desc: "Explore multiple islands in a single day — St. Thomas, St. John, Water Island, and beyond. Every stop brings a new adventure.", icon: "🗺️" },
              ...
              { name: "Daddy Daughter Day on the Boat", desc: "Make memories she'll talk about forever. A private charter just for the two of you — or the whole crew. Special moments on the water.", icon: "💛" },
            ].map((d, i) => (
              <FadeIn key={i} delay={i * 0.05}>
                <div style={{
                  background: `${C.cream}06`, borderRadius: "12px", padding: "20px",
                  border: `1px solid ${C.gold}12`, height: "100%",
                }}>
                  ...
                  <h3 style={{ fontFamily: "'Playfair Display', serif", fontSize: "17px", fontWeight: 700, color: C.cream, margin: "0 0 6px" }}>
                    {d.link ? (
                      <a href={d.link} target="_blank" rel="noopener noreferrer" style={{ color: C.gold, textDecoration: "none" }}>
                        {d.name} ↗
                      </a>
                    ) : d.name}
                  </h3>
                  <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "13px", color: C.sand, lineHeight: 1.6, margin: 0, opacity: 0.8 }}>
                    {d.desc}
                  </p>
                </div>
              </FadeIn>
      ...
      <section id="about" style={{
        ...
        <div style={{ maxWidth: "900px", margin: "0 auto", position: "relative", zIndex: 1 }}>
          ...
          {/* #15 — Luna picture added to right side, 3-column layout: portrait | text | luna photo */}
          <FadeIn delay={0.2}>
            <div style={{
              display: "grid", gridTemplateColumns: "1fr 2fr 1fr", gap: "36px", marginTop: "40px", alignItems: "start",
            }}>
              ...
              <div style={{
                ...
                <img src={familyPhoto} alt="Captain Brian D Vukelic with family" style={{
              ...
              <div>
                ...
                {/* #4 — Larger veteran badge */}
                <div style={{
                  display: "inline-flex", padding: "12px 20px", borderRadius: "8px",
                  border: `1.5px solid ${C.rust}60`, background: `${C.rust}10`, gap: "12px", alignItems: "center",
                }}>
                  <span style={{ fontFamily: "'Oswald', sans-serif", fontSize: "16px", letterSpacing: "3px", color: C.rust, fontWeight: 600 }}>
                    ★ SERVICE DISABLED VETERAN OWNED & OPERATED
                  </span>
                </div>
                <div style={{ marginTop: "8px" }}>
                  <span style={{ fontFamily: "'Oswald', sans-serif", fontSize: "15px", letterSpacing: "3px", color: C.sand, fontWeight: 500 }}>
                    USMC RETIRED • 26 YEARS
                  </span>
                </div>
              </div>

              {/* #15 — Luna photo right side */}
              <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                <div style={{
                  ...
                  <img src={lunaPhoto} alt="Luna — the inspiration behind Luna's Wake" style={{
                    width: "100%", aspectRatio: "3/4", objectFit: "cover", display: "block",
                  }} />
                  <div style={{
                    position: "absolute", bottom: 0, left: 0, right: 0,
                    background: "linear-gradient(transparent, rgba(6,18,34,0.9))",
                    padding: "24px 12px 12px",
                  }}>
                    <p style={{ fontFamily: "'Playfair Display', serif", fontSize: "15px", color: C.cream, margin: "0 0 2px", fontWeight: 700 }}>
                      Meet Luna
                    </p>
                    <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "11px", color: C.sand, margin: 0, opacity: 0.8 }}>
                      The inspiration behind Luna's Wake
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div style={{ maxWidth: "900px", margin: "0 auto" }}>
          <FadeIn>
            <div style={{ textAlign: "center", marginBottom: "48px" }}>
              ...
              <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "clamp(32px, 5vw, 48px)", fontWeight: 800, color: C.navy, margin: "0 0 4px", letterSpacing: "-0.03em" }}>
                Luna's Wake
              </h2>
          ...
          <FadeIn delay={0.2}>
            <div style={{
              ...
              <div style={{ padding: "36px 32px" }}>
                <h3 style={{ fontFamily: "'Playfair Display', serif", fontSize: "22px", fontWeight: 700, color: C.cream, margin: "0 0 4px" }}>
        ...
        <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
          <FadeIn>
            <div style={{ textAlign: "center", marginBottom: "40px" }}>
              ...
              <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "clamp(28px, 5vw, 42px)", fontWeight: 800, color: C.navy, margin: 0, letterSpacing: "-0.03em" }}>
                The 2025 Monterey 30 Elite
              </h2>
              <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "14px", color: "#8b8378", marginTop: "8px" }}>
                Boating Magazine's 2024 Boat of the Year • Miami Innovation Award Winner
              </p>
            </div>
          </FadeIn>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "24px" }}>
            <FadeIn>
              <div style={{ background: "#fff", borderRadius: "16px", padding: "28px", border: `1px solid ${C.sand}40` }}>
                <h3 style={{ fontFamily: "'Oswald', sans-serif", fontSize: "14px", letterSpacing: "3px", color: C.sea, marginBottom: "16px", fontWeight: 600 }}>
                  ✓ BRING WITH YOU
                </h3>
                {[
                  // #17 — 1 towel per person, removed fuel from list
                  "1 towel per person",
                  ...
                  "Light cover-up or rash guard (UPF recommended)",
                  "Dry bag for electronics & valuables",
                  "Snacks & sandwiches if desired (cooler space available)",
            ...
            <FadeIn delay={0.15}>
              <div style={{ background: "#fff", borderRadius: "16px", padding: "28px", border: `2px solid ${C.rust}25` }}>
                <h3 style={{ fontFamily: "'Oswald', sans-serif", fontSize: "14px", letterSpacing: "3px", color: C.rust, marginBottom: "16px", fontWeight: 600 }}>
                  ✗ DO NOT BRING
                </h3>
                {[
        ...
        <div style={{ maxWidth: "800px", margin: "0 auto" }}>
          <FadeIn>
            <div style={{ textAlign: "center", marginBottom: "48px" }}>
              ...
              <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "clamp(28px, 5vw, 42px)", fontWeight: 800, color: C.cream, margin: 0, letterSpacing: "-0.03em" }}>
                Frequently Asked
              </h2>
            </div>
          </FadeIn>
      ...
      <section id="veterans" style={{
        ...
        <div style={{ maxWidth: "600px", margin: "0 auto", position: "relative", zIndex: 1 }}>
          <FadeIn>
            {/* #4 — Larger veteran badge */}
            <div style={{
              display: "inline-block", padding: "16px 32px", borderRadius: "10px",
              border: `2px solid ${C.rust}`, background: `${C.rust}10`, marginBottom: "24px",
            }}>
              <p style={{ fontFamily: "'Oswald', sans-serif", fontSize: "20px", letterSpacing: "5px", color: C.rust, margin: "0 0 4px", fontWeight: 600 }}>
                ★ SERVICE DISABLED VETERAN OWNED ★
              </p>
              <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "14px", letterSpacing: "3px", color: C.sand, margin: 0 }}>
          ...
          <FadeIn delay={0.15}>
            <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "clamp(28px, 5vw, 42px)", fontWeight: 800, color: C.cream, margin: "0 0 12px", letterSpacing: "-0.03em" }}>
          ...
          <FadeIn delay={0.3}>
            <div style={{ padding: "32px 40px", borderRadius: "16px", background: `linear-gradient(135deg, ${C.deepNavy}, ${C.navy})`, border: `2px solid ${C.gold}30`, boxShadow: `0 12px 48px rgba(0,0,0,0.3)` }}>
              <p style={{ fontFamily: "'Playfair Display', serif", fontSize: "22px", color: C.cream, margin: "0 0 8px", fontWeight: 700 }}>
                Military, Veterans & Locals
              </p>
              <p style={{ fontFamily: "'Oswald', sans-serif", fontSize: "48px", color: C.gold, margin: "0 0 8px", fontWeight: 600, letterSpacing: "3px", lineHeight: 1 }}>
                10% OFF
              </p>
            ...
            {testimonials.map((t, i) => (
              <FadeIn key={i} delay={i * 0.15}>
                <div style={{ background: "#fff", borderRadius: "16px", padding: "28px", border: `1px solid ${C.sand}40`, boxShadow: "0 4px 20px rgba(0,0,0,0.03)", height: "100%", display: "flex", flexDirection: "column" }}>
                  ...
                  <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "14px", lineHeight: 1.7, color: "#5a554e", margin: "0 0 20px", flex: 1, fontStyle: "italic" }}>
                    "{t.text}"
                  </p>
                  <div>
      ...
      {/* ═══ FRIENDS & PARTNERS ═══ — #18b Everlong Excursions */}
      <section style={{
        padding: "60px 24px",
        ...
        <div style={{ maxWidth: "800px", margin: "0 auto", textAlign: "center" }}>
          <FadeIn>
            ...
            <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "clamp(24px, 4vw, 36px)", fontWeight: 800, color: C.cream, margin: "0 0 12px", letterSpacing: "-0.03em" }}>
              Friends We Do Business With
            </h2>
            <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "15px", color: C.sand, margin: "0 0 40px", opacity: 0.8 }}>
              Trusted local partners who share our commitment to exceptional USVI experiences.
            </p>
          </FadeIn>
          <FadeIn delay={0.2}>
            <a
              href="https://www.everlongexcursions.com/"
              target="_blank"
              rel="noopener noreferrer"
              style={{
                display: "inline-flex", alignItems: "center", gap: "20px",
                padding: "24px 36px", borderRadius: "16px",
                background: `${C.cream}06`, border: `1.5px solid ${C.gold}30`,
                textDecoration: "none",
                transition: "border-color 0.2s",
              }}
            >
              ...
              <div style={{ textAlign: "left" }}>
                <p style={{ fontFamily: "'Playfair Display', serif", fontSize: "22px", fontWeight: 700, color: C.gold, margin: "0 0 4px" }}>
                  Everlong Excursions
                </p>
                <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "13px", color: C.sand, margin: "0 0 6px", opacity: 0.8 }}>
                  Premier USVI sailing excursions and adventures
                </p>
                <span style={{ fontFamily: "'Oswald', sans-serif", fontSize: "11px", letterSpacing: "2px", color: C.gold, opacity: 0.7 }}>
                  www.everlongexcursions.com ↗
                </span>
              </div>
            </a>
          </FadeIn>
      ...
      <section id="book-now" style={{
        ...
        <div style={{ maxWidth: "600px", margin: "0 auto", position: "relative", zIndex: 1 }}>
          <FadeIn>
            ...
            <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "clamp(32px, 5vw, 52px)", fontWeight: 800, color: C.cream, margin: "20px 0 8px", letterSpacing: "-0.03em" }}>
              Ready to Get Knotty?
            </h2>
            <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "16px", lineHeight: 1.7, color: C.sand, margin: "0 0 36px", opacity: 0.85 }}>
          ...
          <FadeIn delay={0.2}>
            <div style={{ display: "flex", gap: "16px", justifyContent: "center", flexWrap: "wrap", marginBottom: "32px" }}>
              <a href="mailto:KMCUSVI@gmail.com" style={{ display: "inline-flex", alignItems: "center", gap: "8px", padding: "16px 36px", borderRadius: "10px", background: C.gold, color: C.navy, fontFamily: "'DM Sans', sans-serif", fontSize: "16px", fontWeight: 700, textDecoration: "none", boxShadow: `0 6px 28px ${C.gold}30` }}>
                Book Your Charter
              </a>
              <a href="tel:+15712327040" style={{ display: "inline-flex", alignItems: "center", gap: "8px", padding: "16px 36px", borderRadius: "10px", background: "transparent", color: C.cream, border: `1.5px solid ${C.cream}30`, fontFamily: "'DM Sans', sans-serif", fontSize: "16px", fontWeight: 500, textDecoration: "none" }}>
                Call Us Direct
              </a>
            </div>
          </FadeIn>
      ...
      {/* ═══ FOOTER ═══ */}
      <footer style={{ background: C.deepNavy, padding: "32px 24px", borderTop: `3px solid ${C.gold}20` }}>
        <div style={{ maxWidth: "900px", margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "20px" }}>
          <div>
            ...
            <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "12px", color: C.sand, margin: 0, opacity: 0.5, letterSpacing: "1px" }}>U.S. Virgin Islands · Aboard Luna's Wake</p>
          </div>
          <div style={{ textAlign: "right" }}>
            {/* #4 — Larger veteran badge in footer */}
            <div style={{ display: "inline-flex", padding: "8px 16px", borderRadius: "6px", border: `1px solid ${C.rust}50`, background: `${C.rust}08`, gap: "6px", alignItems: "center", marginBottom: "8px" }}>
            ...
            <p style={{ fontFamily: "'Oswald', sans-serif", fontSize: "12px", letterSpacing: "2px", color: C.sand, margin: "0 0 6px", opacity: 0.6 }}>USMC RETIRED • 26 YEARS</p>
